...
async function main() {
  ...
  const eventDefs = [
    // Control Club (venue, approved)
    {
      ...
      genres: ["techno", "minimal"], event_type: "club_night", price: 60,
      price_options: [{ name: "Standard", price: 60 }, { name: "VIP", price: 90 }],
      ticket_url: "https://example.com/tickets/cc-techno",
    ...
    },
    {
      ...
      genres: ["minimal"], event_type: "club_night", price: 50, ticket_url: "https://example.com/tickets/cc-minimal",
    ...
    },
    {
      ...
      genres: ["open_format"], event_type: "party", price: 40, ticket_url: "https://example.com/tickets/cc-open",
    ...
    },
    {
      ...
      genres: ["techno"], event_type: "club_night", price: 70, ticket_url: "https://example.com/tickets/cc-warehouse",
      cover_image_url: nextImg(), is_promoted: false, promotion_intensity: 1,
    ...
    // Kulturhaus (venue, approved)
    {
      ...
      genres: ["house"], event_type: "party", price: 40, ticket_url: "https://example.com/tickets/kh-house",
      cover_image_url: nextImg(), is_promoted: false, promotion_intensity: 1,
    ...
    },
    {
      ...
      genres: ["commercial"], event_type: "party", price: 35, ticket_url: "https://example.com/tickets/kh-hits",
      cover_image_url: nextImg(), is_promoted: false, promotion_intensity: 1,
    ...
    },
    {
      ...
      genres: ["pop"], event_type: "brunch_day_party", price: 30, ticket_url: "",
      cover_image_url: nextImg(), is_promoted: false, promotion_intensity: 1,
    ...
    // Sky Lounge (venue, approved)
    {
      ...
      genres: ["afro_house"], event_type: "rooftop", price: 60, ticket_url: "https://example.com/tickets/sl-afro",
      cover_image_url: nextImg(), is_promoted: true, promotion_intensity: 2,
    ...
    },
    {
      ...
      genres: ["latin"], event_type: "rooftop", price: 45, ticket_url: "https://example.com/tickets/sl-latin",
      cover_image_url: nextImg(), is_promoted: false, promotion_intensity: 1,
    ...
    },
    {
      ...
      genres: ["house"], event_type: "rooftop", price: 55, ticket_url: "https://example.com/tickets/sl-closing",
      cover_image_url: nextImg(), is_promoted: false, promotion_intensity: 1,
    ...
    // Subterra (venue, pending business — events awaiting business approval)
    {
      ...
      genres: ["techno"], event_type: "club_night", price: 45, ticket_url: "https://example.com/tickets/sub-industrial",
      cover_image_url: nextImg(), is_promoted: false, promotion_intensity: 1,
    ...
    },
    {
      ...
      genres: ["live_music"], event_type: "live_performance", price: 50, ticket_url: "https://example.com/tickets/sub-live",
      cover_image_url: nextImg(), is_promoted: false, promotion_intensity: 1,
    ...
    // Green Hours (venue, suspended — event created before suspension, stays live)
    {
      ...
      genres: ["jazz"], event_type: "live_performance", price: 30, ticket_url: "https://example.com/tickets/gh-jazz",
      cover_image_url: nextImg(), is_promoted: false, promotion_intensity: 1,
    ...
    // Night Collective (organizer, approved — different venue each event)
    {
      ...
      genres: ["hip_hop_rnb"], event_type: "social_gathering", price: 25, ticket_url: "https://example.com/tickets/nc-hiphop",
      cover_image_url: nextImg(), is_promoted: true, promotion_intensity: 2,
    ...
    },
    {
      ...
      genres: ["edm"], event_type: "festival", price: 90, ticket_url: "https://example.com/tickets/nc-edm",
      cover_image_url: nextImg(), is_promoted: true, promotion_intensity: 3,
    ...
    },
    {
      ...
      genres: ["pop"], event_type: "private_event", price: null, ticket_url: "",
      cover_image_url: nextImg(), is_promoted: false, promotion_intensity: 1,
    ...
    // Bass Therapy Events (organizer, rejected)
    {
      ...
      genres: ["edm"], event_type: "party", price: 40, ticket_url: "https://example.com/tickets/bt-dnb",
      cover_image_url: nextImg(), is_promoted: false, promotion_intensity: 1,
    ...
    // Admin-added (manual, 30% per spec)
    {
      ...
      genres: ["jazz"], event_type: "live_performance", price: 35, ticket_url: "https://example.com/tickets/admin-jazz",
      cover_image_url: nextImg(), is_promoted: false, promotion_intensity: 1,
    ...
    },
    {
      ...
      genres: ["latin"], event_type: "social_gathering", price: 30, ticket_url: "https://example.com/tickets/admin-latin",
      cover_image_url: nextImg(), is_promoted: false, promotion_intensity: 1,
    ...
    },
    {
      ...
      genres: ["open_format"], event_type: "party", price: 20, ticket_url: "",
      cover_image_url: nextImg(), is_promoted: false, promotion_intensity: 1,
